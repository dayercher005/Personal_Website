...
export default function ProfileCardButtons (){
    ...
    return (
        <div className="flex align-center items-center gap-5">
            ...
            <a href="https://www.linkedin.com/in/dayer-cher-9a9a14231/" target="_blank"><svg className="hover:scale-110 border rounded-full p-2 hover:bg-sky-600 hover:border-sky-600 hover:fill-white transition transition-300" xmlns="http://www.w3.org/2000/svg" width="4em" height="4em" viewBox="0 0 432 432">
