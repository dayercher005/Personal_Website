...
export default function ProfileCardButtons (){
    ...
    return (
        <div className="flex align-center items-center gap-5">
            ...
            <button className="text-base font-medium rounded-xl border border-gray-400 px-2.5 py-1.5 h-fit hover:bg-blue-400 hover:text-white hover:border-blue-400 hover:scale-110 transition transition-300">{projectText}</button>
            <svg className="size:lg hover:bg-gray-900 transition-300 rounded-full p-2 hover:fill-white" xmlns="http://www.w3.org/2000/svg" width="4em" height="4em" viewBox="0 0 432 416">
            ...
            <svg className="border rounded-full p-2 hover:bg-sky-600 hover:border-sky-600 hover:fill-white transition-300" xmlns="http://www.w3.org/2000/svg" width="4em" height="4em" viewBox="0 0 432 432">
