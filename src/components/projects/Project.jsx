...
export default function Project({
  ...
  return (
    <div className="lg:w-auto w-7/10 border-gray-200 border rounded-2xl hover:shadow-2xl hover:scale-103 transition mx-auto my-20">
      ...
      <div className="ml-6 mt-5 mb-4 mr-2 gap-4 flex">
        <a
          className="group border-gray-300 hover:border-blue-400 hover:bg-blue-400 hover:text-white hover:scale-112 flex border py-0.75 px-2 rounded-2xl items-center font-medium transition transition-300"
          href={GithubLink}
        >
          <svg
            className="group-hover:fill-white transition transition-300 rounded-full p-1"
        ...
        <a
          className="group border-gray-300 hover:border-blue-400 hover:bg-blue-400 hover:text-white hover:scale-112 flex items-center border py-0.75 px-2 rounded-2xl font-medium transition transition-300"
          href={LivePreviewLink}
        >
          <svg
            className="group-hover:fill-white transition transition-300"
            xmlns="http://www.w3.org/2000/svg"
            width="2.4em"
            height="2.4em"
            viewBox="0 0 24 24"
