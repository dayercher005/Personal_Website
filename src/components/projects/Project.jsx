    ...
    return(
        <div className="lg:w-auto w-7/10 border-gray-200 border rounded-2xl hover:shadow-2xl hover:scale-103 transition mx-auto">
            ...
            <div className="ml-6 mt-5 mb-4 mr-2 gap-4 flex">
                <a className="group border-gray-300 hover:border-blue-400 hover:bg-blue-400 hover:text-white hover:scale-112 flex border py-0.75 px-2 rounded-2xl items-center font-medium transition transition-300" href={GithubLink}>
                ...
                <a className="group border-gray-300 hover:border-blue-400 hover:bg-blue-400 hover:text-white hover:scale-112 flex items-center border py-0.75 px-2 rounded-2xl font-medium transition transition-300" href={LivePreviewLink}>
